...
def run(playwright: Playwright) -> None:
    ...
    page1.locator("iframe[name=\"iframeSystem\"]").content_frame.get_by_text("租户逐时表底数(正向有功电能)").click()
    time.sleep(1)
    ...
    download.save_as(os.path.join(save_dir, "能耗表底.xls"))
    print(f"文件已保存至：{save_dir}\\能耗表底.xls")
    # ---------------------------
